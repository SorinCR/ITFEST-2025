...
// Updated SubscriptionSelector with enhanced highlight styles
const SubscriptionSelector = ({ selectedTier, setSelectedTier }) => {
    const cardStyles = (tier) => ({
        cursor: 'pointer',
        borderColor: selectedTier === tier ? 'primary.main' : 'grey.300',
        borderRadius: 2,
        transition: 'all 0.3s',
        boxShadow: selectedTier === tier ? 6 : 1,
        backgroundColor: selectedTier === tier ? 'action.selected' : 'background.paper',
        '&:hover': {
            boxShadow: 4,
        },
    });
...
export default function Checkout(props) {
    ...
    const [selectedTier, setSelectedTier] = React.useState('professional');
        ...
        <AppTheme {...props}>
            ...
            >
                ...
                >
                    ...
                    >
                        <SubscriptionSelector selectedTier={selectedTier} setSelectedTier={setSelectedTier} />
                    </Box>
                </Grid>
                <Grid
                        ...
                        {activeStep === steps.length ? (
                            <Stack spacing={2} useFlexGap>
                                ...
                                <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                                    ...
                                    <strong>&nbsp;#140396</strong>. We have emailed your order confirmation and will update you once its shipped.
                                </Typography>
