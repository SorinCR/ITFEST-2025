...
export function SitemarkIcon() {
    ...
    //             <path
    //                 fill="#4876EE"
    //                 d="M50.106 14.97V7.11h1.835v2.595c.088-.74.31-1.338.665-1.791.481-.603 1.174-.904 2.08-.904h.303v1.98h-.578c-.635 0-1.127.172-1.473.516-.347.334-.52.822-.52 1.463v4.001h-2.312ZM59.92 11.298h.767l2.499 3.672h2.6l-3.169-4.51 2.606-3.35h-2.427l-2.875 3.737V4.5h-2.312v10.47h2.312v-3.672Z"
    //                 fill="white"
    //             />
    //         </svg>
    //     </SvgIcon>
    // );
    return <img src="/src/assets/logo.png" width="150px" height="50px"></img>
}
